...
export default class ActivityStore {
  ...
  get activitiesByDate() {
    return Array.from(this.activitiesRegistry.values()).sort((a, b) => b.date!.getTime() - a.date!.getTime())
  }
  ...
  private setActivity = (activity: Activity) => {
    ...
    if (user) {
      activity.isGoing = activity.attendees?.some((item) => item.username === user.username)
